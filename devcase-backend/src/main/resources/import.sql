...
INSERT INTO public.templates (id, name, content, subject) VALUES (1, 'init_4candidate', '', 'Repository created for ${candidate.githubUserName} | Sytac ${project_type} DevCase');
INSERT INTO public.templates (id, name, content, subject) VALUES (4, 'review_complete_4team', '', 'The ${project_type} project of ${candidate.name} had been reviewed');
INSERT INTO public.templates (id, name, content, subject) VALUES (3, 'devcase_available_for_review_4team', '', 'The ${project_type} project of ${candidate.name} is available for review');
INSERT INTO public.templates (id, name, content, subject) VALUES (5, 'devcase_archived_4team', '', 'The ${project_type} project of ${candidate.name} had been archived');
INSERT INTO public.templates (id, name, content, subject) VALUES (2, 'init_4team', '', 'A repository has been created for ${candidate.name}.');
